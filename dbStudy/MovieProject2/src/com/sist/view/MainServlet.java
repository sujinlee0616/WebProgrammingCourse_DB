...
@WebServlet("/MainServlet") //<==annotation
 ...
 * 
 * # JSP vs Servlet
 * - JSP는 Servlet의 doGet 또는 doPost 안에다가 코딩하는 것과 같다. 
 * - 즉, JSP는 메소드 안에 코딩하는 것과 같으므로, request/response 등을 선언하거나 객체를 생성하지 않고도 바로 사용할 수 있다. (내장객체) 
 *   JSP 페이지가 Servlet으로 변환될 때 JSP 컨테이너가 자동적으로 제공을 하기 때문이다.
 *   
 * # JSP 내장객체
 *  : 9개(request, response, out, session, application, pageContext, page, config, exception)가 있다. 
 *     
 */
